...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for shampoo name" title="Type in a name" style="width:76%; margin-left:150px;">
...
<table id="myTable">
  ...
  $sql = "SELECT name, price, quantity FROM shampoo";
