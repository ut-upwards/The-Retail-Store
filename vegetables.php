...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for vegetable name.." title="Type in a name" style="width:76%; margin-left:150px;">

<br><br>

<table id="myTable">
  <tr class="header">
    <th><h3 style="text-align:center;">Available vegetable</h3></th>
  ...
  $sql = "SELECT vegetable_name, quantity, price FROM vegetables";
  ...
  if ($result->num_rows > 0) 
  {
    ...
    while($row = $result->fetch_assoc()) 
      {
        echo  "</td><td>" . $row["vegetable_name"] . "</td><td>"
