...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for deodrants.." title="Type in a name" style="width:76%; margin-left:150px;">
...
<table id="myTable">
  <tr class="header">
    ...
    <th><h3 style="text-align:center;">Company Name</h3> </th>
    <th><h3 style="text-align:center;">Price per item</h3> </th>
    <th><h3 style="text-align:center;">Number of items</h3> </th>
  </tr>
  ...
  $sql = "SELECT name, company_name, price, quantity FROM deodrants";
