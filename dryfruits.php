...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Dryfruit name.." title="Type in a name" style="width:76%; margin-left:150px;">

<br><br>

<table id="myTable">
  <tr class="header">
    <th><h3 style="text-align:center;">Available Dryfruit</h3></th>
  ...
  $sql = "SELECT name, price, quantity FROM dryfruits";
