...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for city.." title="Type in a name" style="width:76%; margin-left:150px;">

<br><br>

<table id="myTable">
  <tr class="header">
    <th><h3 style="text-align:center;">City</h3></th>
    <th><h3 style="text-align:center;">Address</h3> </th>
    <th><h3 style="text-align:center;">State</h3> </th>
  ...
  $sql = "SELECT city, address, state, phone FROM stores";
  ...
  if ($result->num_rows > 0) 
  {
    ...
    while($row = $result->fetch_assoc()) 
      {
        echo  "</td><td>" . $row["city"] . "</td><td>"
        .$row["address"]."</td><td>" . $row["state"]."</td><td>" . $row["phone"] ."</td></tr>";
      }
  echo "</table>";
  }   
