...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for utensil.." title="Type in a name" style="width:76%; margin-left:150px;">

<br><br>

<table id="myTable">
  <tr class="header">
    <th><h3 style="text-align:center;">Utensil</h3></th>
    <th><h3 style="text-align:center;">Material</h3> </th>
    <th><h3 style="text-align:center;">Price</h3> </th>
    <th><h3 style="text-align:center;">Quantity in stock</h3> </th>
  </tr>
  ...
  $sql = "SELECT utensil_name, material, price, quantity FROM kitchen_utensils";
  ...
  if ($result->num_rows > 0) 
  {
    ...
    while($row = $result->fetch_assoc()) 
      {
        echo  "</td><td>" . $row["utensil_name"] . "</td><td>"
        .$row["material"]."</td><td>" . $row["price"]."</td><td>" . $row["quantity"] ."</td></tr>";
      }
  echo "</table>";
  }   
