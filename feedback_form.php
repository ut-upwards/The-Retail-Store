...
<?php
	...
	{	
		...
		$db = mysqli_select_db($link,'retail_store'); 
		if(!$db){ 
		...
		$query = "INSERT INTO feedback VALUES ('$customer_name', '$email', $age, '$helpful_rating', '$UX_rating','UI_rating', '$recommend_rating')"; 
...
if($results == FALSE)
	{	
		echo 'Error:Data not inserted '. mysqli_error($link) . '<br>';
	}
	else
	{
